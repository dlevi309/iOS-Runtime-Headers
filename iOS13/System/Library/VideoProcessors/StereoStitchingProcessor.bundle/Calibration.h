...
@interface Calibration : NSObject {
	...
	SCD_Struct_Ca51 _pixelBufferDimensions[2];
	...
	SCD_Struct_Fi8 _auxiliaryPaddingHInv;
	SCD_Struct_Fi8 _rectReferenceToReference;
	SCD_Struct_Fi8 _rectReferenceToAuxiliary;
	SCD_Struct_Fi8 _referenceToRectReference;
...
@property (nonatomic,readonly) SCD_Struct_Fi8 auxiliaryPaddingHInv;                  //@synthesize auxiliaryPaddingHInv=_auxiliaryPaddingHInv - In the implementation block
@property (nonatomic,readonly) SCD_Struct_Fi8 rectReferenceToReference;              //@synthesize rectReferenceToReference=_rectReferenceToReference - In the implementation block
@property (nonatomic,readonly) SCD_Struct_Fi8 rectReferenceToAuxiliary;              //@synthesize rectReferenceToAuxiliary=_rectReferenceToAuxiliary - In the implementation block
@property (nonatomic,readonly) SCD_Struct_Fi8 referenceToRectReference;              //@synthesize referenceToRectReference=_referenceToRectReference - In the implementation block
-(void)dealloc;
...
-(void)setBufferDimensions:(SCD_Struct_Ca51)arg1 forBufferType:(int)arg2 ;
...
-(SCD_Struct_Fi8)auxiliaryPaddingHInv;
-(SCD_Struct_Fi8)rectReferenceToReference;
-(SCD_Struct_Fi8)rectReferenceToAuxiliary;
-(SCD_Struct_Fi8)referenceToRectReference;
@end
