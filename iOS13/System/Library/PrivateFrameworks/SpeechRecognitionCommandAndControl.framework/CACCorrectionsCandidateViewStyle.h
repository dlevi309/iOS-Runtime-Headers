...
@property (assign,nonatomic) BOOL showOneMoreCandidateWhenMovingBackwards;                     //@synthesize showOneMoreCandidateWhenMovingBackwards=_showOneMoreCandidateWhenMovingBackwards - In the implementation block
