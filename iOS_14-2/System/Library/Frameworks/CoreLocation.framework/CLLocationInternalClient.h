...
-(unsigned char)getLocationForBundleID:(const CFStringRef)arg1 orBundlePath:(const CFStringRef)arg2 dynamicAccuracyReductionEnabled:(unsigned char)arg3 allowsAlteredAccessoryLocations:(unsigned char)arg4 location:(SCD_Struct_CL24*)arg5 ;
-(unsigned char)pingDaemon;
-(id)triggerExpiredAuthorizationPurgeOnClientManager;
-(id)getAccessoryMotionSensorLogs;
-(unsigned char)compassCalibrationDatabaseGetBias:(SCD_Struct_CL25*)arg1 magneticField:(SCD_Struct_CL18)arg2 acceleration:(SCD_Struct_CL18)arg3 ;
...
-(void)setMapMatchingRouteHint:(SCD_Struct_CL26*)arg1 count:(int)arg2 routingType:(int)arg3 stepType:(int)arg4 ;
...
-(unsigned char)getGroundAltitudeForBundleID:(const CFStringRef)arg1 orBundlePath:(const CFStringRef)arg2 location:(id)arg3 groundAltitude:(SCD_Struct_CL27*)arg4 ;
