...
-(SCD_Struct_PX34)_pipelineForRenderTexture:(const SCD_Struct_PX37*)arg1 waitForCompilation:(BOOL)arg2 ;
...
-(MTKView *)metalView;
-(void)dealloc;
-(long long)_drawRenderTexture:(SCD_Struct_PX37*)arg1 withCommandEncoder:(id)arg2 ;
@end
