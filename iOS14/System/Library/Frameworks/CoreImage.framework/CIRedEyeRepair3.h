...
-(void)termGrid;
-(CGPoint)threadCentroid:(SCD_Struct_CI52*)arg1 ;
-(void)termShapePoints:(SCD_Struct_CI53*)arg1 ;
-(void)point:(CGPoint)arg1 toGridRow:(int*)arg2 column:(int*)arg3 ;
-(void)removeThreadAtIndex:(int)arg1 ;
-(int)gatherThreadInfo:(SCD_Struct_CI52*)arg1 ;
...
-(int)addPoint:(CGPoint)arg1 toShapePoints:(SCD_Struct_CI53*)arg2 ;
...
-(void)computeLengthsAnglesAndDeltaAnglesForShape:(SCD_Struct_CI53*)arg1 ;
-(int)initShapePoints:(SCD_Struct_CI53*)arg1 withMaxPoints:(int)arg2 ;
-(void)removeSpikesFromShape:(SCD_Struct_CI53*)arg1 ;
...
-(int)improvedShape:(/*function pointer*/void**)arg1 withShape:(SCD_Struct_CI53*)arg2 ;
-(void)removeRedundantPointsFromShape:(SCD_Struct_CI53*)arg1 closerThan:(float)arg2 ;
-(void)removeSmallBumpsFromShape:(SCD_Struct_CI53*)arg1 center:(CGPoint)arg2 threshold:(float)arg3 ;
...
-(float)threadSignedArea:(SCD_Struct_CI52*)arg1 centroid:(CGPoint)arg2 ;
-(int)shape:(/*function pointer*/void**)arg1 withThreadAtIndex:(int)arg2 centroid:(CGPoint)arg3 ;
-(void)slidingWindowAnalysisOfShape:(SCD_Struct_CI53*)arg1 into:(SCD_Struct_CI56*)arg2 ;
-(int)copyShape:(SCD_Struct_CI53*)arg1 into:(SCD_Struct_CI53*)arg2 transform:(CGAffineTransform)arg3 height:(int)arg4 ;
-(int)convexHull:(/*function pointer*/void**)arg1 ofOriented:(BOOL)arg2 shape:(SCD_Struct_CI53*)arg3 ;
